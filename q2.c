...
#define W 1280
#define H 720
typedef unsigned char U;typedef unsigned short S;typedef unsigned int I;typedef int J;typedef float F;typedef struct{F x,y,z;}V;typedef struct{F m[16];}M;typedef struct{I o,l;}L;typedef struct{S v[2];}E;typedef struct{J e;U d;}FE;typedef struct{S p,n,fe,ne,ti;U s[4];J lm,lo[2];U lw,lh,ls[2];}FC;
...
cam=(V){0,0,100};
for(int i=0;i<60;i++){
V t={cam.x+cosf(pi)*cosf(ya),cam.y+cosf(pi)*sinf(ya),cam.z+sinf(pi)};
M mo=ID(),vi=LK(cam,t,(V){0,0,1}),pj=PR(1.2f,(F)W/H,1,4000);
